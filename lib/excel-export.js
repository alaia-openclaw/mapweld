...
/** Line, System, Drawing, Spool, SW name, 6× part cols, fitter ×2, WPS */
 ...
 */
export function buildExportRows(weldPoints, { pdfFilename, spools, parts = [], personnel, drawingSettings, ndtContext = null }) {
...
export function exportWeldsToExcel(weldPoints, options) {
  const { pdfFilename, spools, parts, personnel, drawingSettings, ndtContext, projectMeta = {} } = options;
