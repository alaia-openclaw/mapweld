/**
 * Load pipe catalog from reference Database/Pipe (Node-only, uses fs).
...
/** Schedule from Pipe_*.csv filename — same ASME pipe wall schedule as butt-weld fittings (per file) and flange bore (attributes.schedule). */
