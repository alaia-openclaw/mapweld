...
import { getVirtualCatalogEntryById } from "@/lib/catalog-virtual-valve-entries";
...
export function getCatalogEntry(catalogPartId) {
  return (
    entries.find((e) => e.catalogPartId === catalogPartId) ?? getVirtualCatalogEntryById(catalogPartId) ?? null
  );
}
