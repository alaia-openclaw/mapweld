...
function getHeaderRow(lines) {
  ...
  // Many Pipedata-Pro CSV files start with an index row, with the true header on line 2.
...
function parsePipedataCsv(filePath, standardId, pressureClass, systemLabel) {
  ...
  for (let i = startIndex; i < lines.length; i++) {
    ...
    if (!thickness || thickness.toUpperCase() === "N/A") continue;
